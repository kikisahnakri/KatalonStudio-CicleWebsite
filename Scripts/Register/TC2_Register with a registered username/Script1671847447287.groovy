...
WebUI.setText(findTestObject('Object Repository/Register/input_username'), 'Project2_kiki')

WebUI.setText(findTestObject('Object Repository/Register/input_email'), 'projectemptyemail23@gmail.com')
...
WebUI.verifyElementText(findTestObject('Register/error_message_registered_username'), 'The username has already been taken.')

...
WebUI.setText(findTestObject('Object Repository/Login/inputl_email'), '')

WebUI.setText(findTestObject('Object Repository/Login/input_password'), '')

WebUI.click(findTestObject('Login/button_masuk'))

WebUI.verifyElementText(findTestObject('Login/error_message email'), 'The email field is required.')

WebUI.verifyElementText(findTestObject('Login/error_message password'), 'The password field is required.')
